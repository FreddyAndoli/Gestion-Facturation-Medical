...
<nav style="border-radius:0px; height:20px;background-color:#FFF" class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <p class="navbar-brand">Bienvenu <font color="#7eaefc"> <?php echo $_SESSION['sadmun']; ?>!</font> Vous êtes connecté en tant que <?php echo $_SESSION['admty']; ?> <a href="dminlogout.php">Se déconnecter</a></a>
    </div>
