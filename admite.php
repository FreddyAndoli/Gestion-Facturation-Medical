...
<title>Gestion de Facturation Medical</title>
...
<h1 class="text-center ">Gestion de Facturation Medical<br /><small style="font-size:20px">Hospital Management System</small></h1></div>
</div>
</div>
