...
<h3 style="font-family:calibri;" class="text-center">Informations sur le personnel</h3></div>
</div>
</div>
</div>
<div class="container">
...
<br>
  <dt style="font-size:12px;"><strong>Prénom du personnel: </strong> </dt>
...
<br>
  ...
  <dt style="font-size:12px;"><strong>Nom  du personnel : </strong> </dt>
  ...
  <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Select your Gendere">
      ...
      <option value="Female">Femme</option></select></dd>

  <dt style="font-size:12px;"><strong>Type de membre du personnel: </strong></dt>
      <dd style="font-size:12px;">
      <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Type de personnel">
          <option  value="<?php echo $row["smtype"]; ?>"><?php echo $row["smtype"]; ?></option>
          <option value="Doctor">Médecin</option>
          <option value="Nurse">Infirmier(e)</option>
          <option value="Other">Autre</option></select></dd>

          <dt style="font-size:12px;"><strong>Temps de travail: </strong></dt>
          <dd style="font-size:12px;">
