...
<h3 style="font-family:calibri;" class="text-center">Membres du personnel actifs</h3></div>
</div>
</div>
</div>
<div class="container">
...
<h4 style="font-family:calibri;" class="text-center">Temps plein</h4></div>
<br />
...
<h4 style="font-family:calibri;" class="text-center">Matin</h4></div>
<br />
<table style="background-color:#FFF; font-size:12px; " class="table table-striped table-hover table-bordered">
<thead>
<tr>
...
<h4 style="font-family:calibri;" class="text-center">Soir</h4></div>
<br />
<table style="background-color:#FFF; font-size:12px; " class="table table-striped table-hover table-bordered">
<thead>
<tr>
